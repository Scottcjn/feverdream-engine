...
-- Level 2 — Crate Heights (medium: climbing under pressure)
--
-- The trail climbs. Two prowlers patrol the heights — and these ones come
-- back, so keep moving. The elevator still runs... mostly.
