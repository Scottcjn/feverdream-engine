...
boxes = {
  ...
  { cx =   0, cz =   3, hx = 0.28, hz = 0.28, h = 0.55, r = 1.0, g = 0.85, dyn = true, solid = false, shape = "acorn" },
  { cx =   8, cz =   8, hx = 0.28, hz = 0.28, h = 0.55, r = 1.0, g = 0.85, dyn = true, solid = false, shape = "acorn" },
  { cx =  -8, cz =   8, hx = 0.28, hz = 0.28, h = 0.55, r = 1.0, g = 0.85, dyn = true, solid = false, shape = "acorn" },
  { cx =   9, cz =  -9, hx = 0.28, hz = 0.28, h = 0.55, r = 1.0, g = 0.85, dyn = true, solid = false, shape = "acorn" },
  { cx =  -9, cz =  -9, hx = 0.28, hz = 0.28, h = 0.55, r = 1.0, g = 0.85, dyn = true, solid = false, shape = "acorn" },
  { cx =   0, cz = -11, hx = 0.28, hz = 0.28, h = 0.55, r = 1.0, g = 0.85, dyn = true, solid = false, shape = "acorn" },
}
...
game_title = "Chunkins' Relic Sweep"
